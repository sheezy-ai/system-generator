...
Fixed via the **collapsed model**: cross-cutting *design* / cross-component *invariants* are Architecture/Foundations concerns reached by upward escalation; `cross-cutting.md` stays a downstream contract registry; the step-0 authoring/ratification pass is confirmed a fiction and retired.
