...
2. **Create round directory and copy input**:
   - Create `system-design/01-blueprint/versions/round-[N]-review/`
...
3. **Spawn expert agents in parallel** using Task tool
   - Pass to each agent:
     - Blueprint file path: `system-design/01-blueprint/versions/round-[N]-review/00-blueprint.md`
   ...
   - Agents write directly to `system-design/01-blueprint/versions/round-[N]-review/01-[expert-name].md`
...
8. **Run Consolidator** (MUST spawn as subagent using Task tool - do NOT perform inline)
   ...
   - Agent writes to `system-design/01-blueprint/versions/round-[N]-review/02-consolidated-issues.md`
...
12. **Run Scope Filter agent** (MUST spawn as subagent using Task tool - do NOT perform inline)
    ...
    Input: system-design/01-blueprint/versions/round-[N]-review/02-consolidated-issues.md
    Output: system-design/01-blueprint/versions/round-[N]-review/03-issues-discussion.md
    ```
...
16. **Run Issue Analyst agents** (MUST spawn as subagents using Task tool - do NOT perform inline)
    ...
    Context documents:
    - Blueprint: system-design/01-blueprint/versions/round-[N]-review/00-blueprint.md

    Issues file: system-design/01-blueprint/versions/round-[N]-review/03-issues-discussion.md
    Issues: [ID1, ID2, ID3, ...]
    ```
...
21. **Notify user** issues are ready for discussion
    - Point them to `system-design/01-blueprint/versions/round-[N]-review/03-issues-discussion.md`
...
27. **Run Author agent**
    ...
    - Agent writes to `system-design/01-blueprint/versions/round-[N]-review/04-author-output.md` (changelog) and `system-design/01-blueprint/versions/round-[N]-review/05-updated-blueprint.md`
...
31. **Spawn both verification agents in parallel**:
    ...
    **Change Verifier** (Step 6):
    ...
    - Agent writes to `system-design/01-blueprint/versions/round-[N]-review/06-change-verification-report.md`
    ...
    **Internal Coherence Checker** (Step 7) (`{{AGENTS_PATH}}/universal-agents/internal-coherence-checker.md`):
    ...
    - Agent writes to `system-design/01-blueprint/versions/round-[N]-review/07-coherence-report.md`
    ```
    Follow the instructions in: {{AGENTS_PATH}}/universal-agents/internal-coherence-checker.md

    Document: system-design/01-blueprint/versions/round-[N]-review/05-updated-blueprint.md
    Stage guide: guides/01-blueprint-guide.md
    Output: system-design/01-blueprint/versions/round-[N]-review/07-coherence-report.md
    ```
...
45. **Copy reviewed Blueprint to canonical path**:
    - Copy `system-design/01-blueprint/versions/round-[N]-review/05-updated-blueprint.md` to `system-design/01-blueprint/blueprint.md`
