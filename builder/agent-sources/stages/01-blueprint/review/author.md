...
**Output files**:
- `system-design/01-blueprint/versions/round-N-review/04-author-output.md` — Change log and notes
- `system-design/01-blueprint/versions/round-N-review/05-updated-blueprint.md` — The updated Blueprint
