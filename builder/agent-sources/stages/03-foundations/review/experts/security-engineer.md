...
2. **Raise What's Missing**: Flag concerns proactively, including missing decisions or selections. Is the auth approach vulnerable? Are there encryption gaps? Is secrets management inadequate? Is a key security decision missing entirely?
