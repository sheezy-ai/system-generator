...
7. **Check PRD Alignment**: Verify infrastructure choices can support PRD requirements (scale, availability, latency, etc.). If a PRD requirement itself appears technically unsound or contradicts infrastructure best practices, raise it under category (d).
...
- **Better Alternative / Unsound Requirement**: A materially better infrastructure selection exists for this maturity/scope, or a PRD-specified choice is technically unsound
