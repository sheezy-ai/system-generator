...
- Blueprint in Step 1 (deferred items validation) — this is structural validation (topic addressed yes/no), not content generation

**What You Do NOT Read:**
- Agent prompt files — agents read their own instructions
- Input documents being passed to agents (Blueprint for generation, guide, brief, etc.)
