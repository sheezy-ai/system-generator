...
| Contract layer materializing (`Population: MATERIALIZING`) | Error: "Contract layer materialization incomplete. Re-run the initialize orchestrator's Step 3a before creating components." |
