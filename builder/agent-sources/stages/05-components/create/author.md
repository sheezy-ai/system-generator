...
3. **Update Issues Summary** — Mark resolved items as checked `[x]` or update counts in the Issues Summary section
...
4. **Update the Issues Summary** — Find the matching item and update (decrement count or mark resolved)
5. **Log the change** — Record in the change log

If all Issues Summary counts reach 0 after applying changes, replace the Issues Summary section content with:
```
...
5. **Update Issues Summary** — update counts or mark resolved
6. **Log in change log**
